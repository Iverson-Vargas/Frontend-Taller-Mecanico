            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <Link to="/panel/ReporteNominas" className="group flex flex-col bg-white rounded-3xl p-6 shadow-sm hover:shadow-xl border border-slate-200 transition-all duration-300 ease-in-out hover:-translate-y-1">
                        <div className="w-12 h-12 bg-amber-100 text-amber-600 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                            </svg>
                        </div>
                        <h2 className="text-xl font-bold text-slate-800 mb-2 group-hover:text-amber-500 transition-colors">Reporte de Nóminas</h2>
                        <p className="text-sm text-slate-500 flex-grow">
                            Administración y control de salarios, comisiones y pagos del personal del taller mecánico.
                        </p>
                        <div className="mt-4 pt-4 border-t border-slate-100 flex items-center text-sm font-bold text-amber-600">
                            Generar reporte
                            <svg className="w-4 h-4 ml-1 group-hover:ml-2 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                    ...
                    <Link to="/panel/ReporteGanancia" className="group flex flex-col bg-white rounded-3xl p-6 shadow-sm hover:shadow-xl border border-slate-200 transition-all duration-300 ease-in-out hover:-translate-y-1">
                        ...
                        <h2 className="text-xl font-bold text-slate-800 mb-2 group-hover:text-emerald-500 transition-colors">Reporte de Ganancias</h2>
                        <p className="text-sm text-slate-500 flex-grow">
                            Visualización de la utilidad general. Ingresos netos calculados.
                        </p>
